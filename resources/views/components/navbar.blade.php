    ...
    <nav class="navbar navbar-expand-lg bg-body-tertiary">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <!-- jika sudah login, tampilkan informasi user login -->

                <!-- jika belum login, tampilkan button login dan register -->

                @if(auth()->guard('customer')->check())
                    <!-- tampilkan info user disini -->
                    <div class="dropdown">
                ...
                @else 
                    <!-- tampilkan button login dan register -->
